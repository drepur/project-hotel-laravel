...
@section('content')
    <div class="container">
        ...
        <div class="container">
            <h1>List Jadwal Cek in Hotel
            <a href="{{ route("cekin.form") }}" class="btn btn-success float-right mb-4">
                <i class="fas fa-plus"></i> Tambah Jadwal Cek in</a>
            </h1>
            <hr>
            <table class = "table table-borderless">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="{{ route("cekin.hapus",["id" => $item->id]) }}" class="btn btn-danger float-right"
